...
LISTBOX_HEIGHT  =  3#15
LISTBOX_WIDTH   =  30
SAMPLE_TEXT     =  'ABCDEFG abcdefg 12345'#"0O 1lI| ABC abc"
DEFAULT_SIZE    =  12#14
DEFAULT_FAMILY  =  "helvetica"

class FontSelect(ttk.Frame):
...
class FamilyPicker(ttk.Frame):
    ...
    def __init__ ( self, fontSelect, observer ):
        ...
        #   self  :=  that Frame ]
        ttk.Frame.__init__ ( self, fontSelect )
        #-- 2 --
...
class Controls(ttk.Frame):
    ...
    def __createWidgets ( self ):
        ...
        self.annunciator  =  ttk.Label ( self,
            font=self.fontSelect.regularFont,
            textvariable=self.__fontName,
            text="",foreground='blue' )
        rowx  =  0
        self.annunciator.grid ( row=rowx, sticky=W,padx=8 )
        #-- 2 --
        ...
        self.sample  =  Text ( self,
            ...
            font=self.fontSelect.regularFont )
        rowx  +=  1
        self.sample.grid ( row=rowx, sticky=NSEW,padx=8 )
        ...
        rowx  +=  1
        self.buttons.grid ( row=rowx, sticky='we',padx=5 )
        #-- 4 --
    ...
    def __createButtons ( self ):
        ...
        self.sizeLabel  =  ttk.Label ( self.buttons,
            font=self.fontSelect.regularFont,
            text="Size:" )
        colx  =  0
        self.sizeLabel.grid ( row=0, column=colx,padx=0 )
        #-- 2 --
        ...
        self.sizeField  =  ttk.Entry ( self.buttons,
            font=self.fontSelect.regularFont,
            width=4,
            textvariable=self.__sizeText )
        colx  +=  1
        self.sizeField.grid ( row=0, column=colx,padx=5 )
        ...
        self.boldFont2  =  self.fontSelect.regularFont.copy()
        self.boldFont2.configure ( weight=tkFont.BOLD )        
        self.sizeButton  =  Button ( self.buttons,
            text="Size",
            font=self.boldFont2,
            command=self.__setFont )
        colx  +=  1
        self.sizeButton.grid ( row=0, column=colx,padx=5,pady=5 )
        #-- 4 --
        ...
        self.spacer = ttk.Frame ( self.buttons )
        ...
        self.italicFont.configure ( weight=tkFont.BOLD )
